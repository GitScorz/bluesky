...
JOBS.JobCenter = {
    AddMarkers = function()
        ...
        Markers.Markers:Add('jobcenter', 'jobcenter', location, 27, vector3(0.5, 0.5, 0.5), ({ r = 200, b = 255, g = 0 }
            ), function()
                return true
    ...
    OpenApplicationForJob = function(self, job)
        if jobCenterList[job] then
            ...
            root.Add:Text(charName ..
                ', please sign below to recieve the job: ' ..
                targetJob.label ..
                ' - ' ..
                targetJob.grades[targetJob.jobcenter.default].label ..
                '. Specific job instructions will be given if you are accepted for the job.', { 'pad', 'center' })
    ...
    OpenInfoForJob = function(self, job, name)
        if jobCenterList[job] then
            ...
            root.Add:Text('Congratulations, ' ..
                name ..
                ' you were accepted for the job: ' ..
                targetJob.label .. '. Here are some instructions now that you have the job', { 'pad', 'center' })
