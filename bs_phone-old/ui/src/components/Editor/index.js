...
const useStyles = makeStyles((theme) => ({
	editor: {
		...
		'& .ql-editor ol, .ql-editor ul': { paddingLeft: '1.5em' },
		...
		'& .ql-editor .ql-color-white': { color: theme.palette.text.main },
		...
		'& .ql-snow .ql-tooltip': {
			...
			border: `1px solid ${theme.palette.text.main}4d`,
			color: theme.palette.text.main,
			padding: '10px',
			whiteSpace: 'nowrap',
		},
		...
		'& .ql-snow a': { color: theme.palette.primary.main },
